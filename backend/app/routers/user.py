        ...
        try:
            ...
            if u_res.data:
                ...
                if access_token:
                    ...
                    profile.update({
                        "login": gh_profile.get("login") or db_user.get("github_username"),
                        "name": gh_profile.get("name") or db_user.get("github_username"),
                        ...
                        "html_url": gh_profile.get("html_url", f"https://github.com/{db_user.get('github_username')}"),
